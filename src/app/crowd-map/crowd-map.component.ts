...
@Component({
  selector: 'app-crowd-map',
  templateUrl: './crowd-map.component.html',
  styleUrls: ['./crowd-map.component.css','../app.component.css']
})
export class CrowdMapComponent implements OnInit {
  ...
  constructor(private _visitor: VisitorService, private router: Router) { }
